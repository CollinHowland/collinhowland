        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div className="text-gray-800 space-y-4">
                    <h1 className="text-3xl font-bold">Hi, I'm Collin</h1>
                    <p>I'm a passionate developer and creative thinker who loves learning and building things that make people smile.
                        ...
                        It's never too late to start, so let's see where this takes me and I hope you enjoy a glimpse into my life. 🙂</p>
                    <p>Outside of tech, I’m into whiskey, piano, cooking, video games (okay so maybe still some tech), and new experiences!
                    ...
                    <p>I was feeling a bit of fomo from not putting a personal website/blog out into the world so here it is. Don't be a stranger and reach out!</p>
                </div>
            </div>
            {/* Social Links */}
            <div className="mt-8 flex gap-6 items-center justify-center">
                ...
                >
                    {/* LinkedIn SVG */}
                    <svg className="w-7 h-7 text-blue-700 hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                    {/* GitHub SVG */}
                    <svg className="w-7 h-7 text-gray-800 hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                    {/* Email SVG */}
                    <svg className="w-7 h-7 text-red-600 hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
